...
def italicize_text_in_image_no_artifacts(input_image_path, output_image_path, top_left, bottom_right, background_color=(255, 255, 255)):
...
output_image_path = "output_image_with_italic_text_no_artifacts4.png"  # Path to save the output image
top_left = (192, 240)  # Top-left coordinates of the text region
bottom_right = (307, 261)  # Bottom-right coordinates of the text region
background_color = (0, 0, 0)  # Background color to fill artifacts (default white)

# Apply the transformation
italicize_text_in_image_no_artifacts(input_image_path, output_image_path, top_left, bottom_right, background_color)
